...
exports.login = asyncHandler(async (req, res, next) => {
    ...
    if (!email || !password) {
        return next(new ErrorRespose('Please provide an email and password'));
    }
    ...
    if (!user) {
        return next(
            new ErrorRespose("Invalid credentials", 401)
        );
    }
...
exports.forgotPassword = asyncHandler(async (req, res, next) => {
    ...
    const message = `You are receiving this mail because you (or someone else) has requested
